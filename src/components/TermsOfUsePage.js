        ...
        <div className="container mt-5">
            <div className="bg-white p-4 rounded shadow-sm">
                <div className="terms-of-use-page">
                    ...
                    <section className="how-it-works">
                        <h2>4. Proibição de Uso Comercial</h2>
                        <p>
                    ...
                    <section className="how-it-works">
                        <h2>5. Proteção de Dados Pessoais e LGPD</h2>
                        <p>
                        ...
                        <h3>5.3. Armazenamento e Segurança dos Dados</h3>
                        <p>
                        ...
                        <h3>5.4. Direitos do Titular dos Dados</h3>
                        <p>
