                ...
                <div className="bg-white p-4 rounded shadow-sm">
                    <div className="d-flex flex-column ">
                        <div className="container mt-4">
                            <h2 className="mb-3 mb-0 heading-spacing">Dados da Assinatura Grátis</h2>
                            <div className="wiki-section">
                                <h3 className="mb-3 mb-0 heading-spacing">Tópicos Permitidos</h3>
                            ...
                            <div className="wiki-section">
                                <h3 className="mb-0 heading-spacing">Conteúdo Disponível</h3>
                                <ul className="list-unstyled">
                            ...
                            <div className="wiki-section">
                                <h3 className="mb-0 heading-spacing">Validade</h3>
                                <p>Válido por 3 meses com renovação automática.</p>
                            </div>

                            <h2 className="mt-4 mb-3 heading-spacing">Funcionamento</h2>
                            <div className="wiki-section">
                                <ul className="list-unstyled">
                            ...
                            <h2 className="mt-4 mb-3 heading-spacing">Na Etapa de Revisão do Conteúdo</h2>
                            <div className="wiki-section">
                                <h3 className="mt-4 mb-3 heading-spacing">Nível de Conhecimento</h3>
                                <ul className="list-unstyled">
                            ...
                            <h2 className="mt-4 mb-3 heading-spacing">Fale Conosco</h2>
                            <div className="wiki-section">
                                <ul className="list-unstyled">
